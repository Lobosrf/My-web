  ...
  return (
    <main className="container" style={{ position: 'relative' }}>
      ...
      <section style={{ maxWidth: '600px' }}>
        <h2 style={{ fontSize: '2.5rem', fontWeight: '900', lineHeight: '1.1', marginBottom: '30px', letterSpacing: '-0.03em', color: '#1a1a1a' }}>3 habilidades que todo trader debe dominar</h2>
        ...
        <p style={{ marginTop: '40px', fontWeight: '500' }}>Cada día envío un email en el que cuento cómo hacerlo. Te apuntas ahí:</p>
      </section>

      <form action="https://lobosrf.substack.com/subscribe" method="GET" target="_blank" style={{ marginTop: '20px', maxWidth: '600px' }}>
        <input type="email" name="email" placeholder="Tu mejor email..." required style={{ width: '100%', padding: '12px', border: '1px solid #ccc', borderRadius: '4px', fontSize: '1rem', marginBottom: '10px', backgroundColor: '#fff', color: '#000' }} />
        <button type="submit" style={{ backgroundColor: '#000', color: '#fff', padding: '14px', border: 'none', borderRadius: '4px', fontWeight: 'bold', cursor: 'pointer', width: '100%', fontSize: '1rem' }}>Apuntarme</button>
      </form>
    </main>
  );
}